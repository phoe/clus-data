...
\specref{block} //[[CL:Glossary:establishes]]// a //[[CL:Glossary:block]]// named //name// and then evaluates //forms// as an //[[CL:Glossary:implicit progn]]//.

The //[[CL:Glossary:special operators]]// \specref{block} and \specref{return-from} work together to provide a structured, lexical, non-local exit facility. At any point lexically contained within //[[CL:Glossary:forms]]//, \specref{return-from} can be used with the given //name// to return control and values from the \specref{block} //[[CL:Glossary:form]]//, except when an intervening //[[CL:Glossary:block]]// with the same name has been //[[CL:Glossary:established]]//, in which case the outer //[[CL:Glossary:block]]// is shadowed by the inner one.
...
**[[CL:Macros:return]]**, \specref{return-from}, {\secref\Evaluation}
