...
\Defmeth slot-unbound {\specparam{class}{t} instance slot-name}
...
The default //[[CL:Glossary:method]]// on **[[CL:Functions:slot-unbound]]** signals an error of type **[[CL:Types:unbound-slot]]**.
