...
====Description====
If **[[CL:Variables:*print-readably*]]** is //[[CL:Glossary:true]]//, some special rules for printing //[[CL:Glossary:object|objects]]// go into effect. Specifically, printing any //[[CL:Glossary:object]]// ''O\sub 1'' produces a printed representation that, when seen by the //[[CL:Glossary:Lisp reader]]//

while the //[[CL:Glossary:standard readtable]]// is in effect, will produce an //[[CL:Glossary:object]]// ''O\sub 2'' that is //[[CL:Glossary:similar]]// to ''O\sub 1''. The printed representation produced might or might not be the same as the printed representation produced when **[[CL:Variables:*print-readably*]]** is //[[CL:Glossary:false]]//.
