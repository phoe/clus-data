...
\auxbnf{short-form-option}{**'':documentation''** //documentation// | \CR **'':identity-with-one-argument''** //identity-with-one-argument// |\CR **'':operator''** //operator//} 
\auxbnf{method-group-specifier}{\paren{name \curly{\plusparam{qualifier-pattern} ''\vert'' predicate} \interleave{\down{long-form-option}}}} 
\auxbnf{long-form-option}{**'':description''** //description// |\CR **'':order''** //order// |\CR **'':required''** //required-p//}
