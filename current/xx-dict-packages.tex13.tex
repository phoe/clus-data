...
====Description====
Within the lexical scope of the body //forms//, the //name// is defined via \specref{macrolet} such that successive invocations of **[[CL:Functions:(//name//)]]** will return the //[[CL:Glossary:symbol|symbols]]//, one by one, from the //[[CL:Glossary:package|packages]]// in //package-list//.
...
\beginlist \itemitem{1.} A flag that indicates whether a //[[CL:Glossary:symbol]]// is returned (true means that a //[[CL:Glossary:symbol]]// is returned). \itemitem{2.} A //[[CL:Glossary:symbol]]// that is //[[CL:Glossary:accessible]]// in one the indicated //[[CL:Glossary:package|packages]]//. \itemitem{3.} The accessibility type for that //[[CL:Glossary:symbol]]//; i.e. one of the symbols **'':internal''**, **'':external''**, or **'':inherited''**. \itemitem{4.} The //[[CL:Glossary:package]]// from which the //[[CL:Glossary:symbol]]// was obtained. The //[[CL:Glossary:package]]// is one of the //[[CL:Glossary:package|packages]]// present or named in //package-list//. \endlist
