...
\macref{pprint-logical-block}, **[[CL:Functions:pprint-newline]]**, and
...
\Themacro{formatter} provides the efficiency of using a //[[CL:Glossary:compiled function]]// 
...
The values associated with a key are
 ...
 and a ``numerical priority'' (specifically, a //[[CL:Glossary:real]]//).
...
the //[[CL:Glossary:current pprint dispatch table]]// (in \varref{*print-pprint-dispatch*})
...
The value of \varref{*print-pretty*} is still //[[CL:Glossary:true]]// 
...
function prints out lists whose //[[CL:Glossary:cars]]// are \macref{defun} in the 
...
below.  This specifies how to print a \specref{let} //[[CL:Glossary:form]]// in the traditional
...
readably print any possible list that begins with the //[[CL:Glossary:symbol]]// \specref{let}.
The outermost \macref{pprint-logical-block} //[[CL:Glossary:form]]// handles the printing of
the input list as a whole and specifies that parentheses should be printed in the
output.  The second \macref{pprint-logical-block} //[[CL:Glossary:form]]// handles the list 
of binding pairs.  Each pair in the list is itself printed by the innermost
\macref{pprint-logical-block}.  (A \macref{loop} //[[CL:Glossary:form]]// is used instead of
...
\macref{pprint-logical-block} //[[CL:Glossary:form]]// prints out the forms in the body
of the \specref{let} //[[CL:Glossary:form]]// separated by spaces and 
...
and \varref{*print-circle*} being //[[CL:Glossary:true]]//.
...
be used as **[[CL:Functions:pprint dispatch functions]]** as well as \formatOp{/.../} 
functions.
...
\varref{*print-pretty*} being //[[CL:Glossary:true]]//, \varref{*print-escape*} being //[[CL:Glossary:false]]//,
