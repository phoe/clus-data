...
//[[CL:Glossary:Conditions]]// are \instancesofclasses{condition}.
...
//[[CL:Glossary:Active]]// //[[CL:Glossary:handlers]]// are //[[CL:Glossary:established]]// dynamically
...
Additional //[[CL:Glossary:condition]]// //[[CL:Glossary:types]]// can be defined by using \macref{define-condition}.
...
//[[CL:Glossary:supertype]]// relationships in \macref{define-condition}, 
but the consequences are not specified if an attempt is made to use
a //[[CL:Glossary:condition]]// //[[CL:Glossary:type]]// as a //[[CL:Glossary:superclass]]// in a \macref{defclass} //[[CL:Glossary:form]]//.
...
\Thenextfigure\ shows //[[CL:Glossary:operators]]// that
...
\macref{assert} might also implicitly create (and //[[CL:Glossary:signal]]//)
...
Here are some illustrations of how different //[[CL:Glossary:condition designators]]//
...
If the **'':report''** argument to \macref{define-condition} is used,
a print function is defined that is called whenever 
the defined //[[CL:Glossary:condition]]// is printed while \thevalueof{*print-escape*} is //[[CL:Glossary:false]]//. 
...
When a //[[CL:Glossary:condition]]// is printed and \varref{*print-escape*}
...
When \varref{*print-escape*} is //[[CL:Glossary:true]]//, the //[[CL:Glossary:object]]// should print in an
...
The requirements on a //[[CL:Glossary:program]]// or //[[CL:Glossary:implementation]]// which
invokes a //[[CL:Glossary:condition reporter]]// are somewhat stronger.  A \term{conforming
...
Each //[[CL:Glossary:handler]]// is associated with a //[[CL:Glossary:type specifier]]//
that must designate a \subtypeof{condition}.  A //[[CL:Glossary:handler]]//
...
On the other hand, in an //[[CL:Glossary:implementation]]// that implemented asynchronous 
...
The //[[CL:Glossary:restarts]]// //[[CL:Glossary:established]]// by 
 ...
 or a \macref{with-simple-restart} //[[CL:Glossary:form]]//
...
\beginlist
 ...
 \itemitem{1.} Each //[[CL:Glossary:restart]]// in a set of active restarts
...
established.
 ...
 \itemitem{2.} Let $r\sub 1$ and $r\sub 2$ be two active //[[CL:Glossary:restarts]]// with
...
**'':report''** keyword to \macref{restart-case}. 
...
\macref{restart-bind} or **'':interactive''** keyword
to \macref{restart-case}, is used when the //[[CL:Glossary:restart]]//
is invoked
...
the **'':test-function''** option to \macref{restart-bind} or 
the **'':test''** option to \macref{restart-case}.
