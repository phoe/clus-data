...
The //[[CL:Glossary:evaluation environment]]// is a //[[CL:Glossary:run-time environment]]//
...
The term //[[CL:Glossary:run-time compiler]]// refers to \thefunction{compile}
...
Note that when the //[[CL:Glossary:run-time compiler]]// is used,
the //[[CL:Glossary:run-time environment]]// 
...
//[[CL:Glossary:macro]]// definition, but also //[[CL:Glossary:shadows]]//\meaning{2} the //[[CL:Glossary:compiler macro]]//.
...
for defining local //[[CL:Glossary:compiler macros]]// in the way that \specref{macrolet}
...
When **[[CL:Functions:eval]]** encounters a //[[CL:Glossary:form]]// during processing that represents 
a call to a //[[CL:Glossary:compiler macro]]// //[[CL:Glossary:name]]// (that is not declared **[[CL:Declarations:notinline]]**),
...
\itemitem{\bull} All //[[CL:Glossary:compiler macro]]//\idxterm{compiler macro} calls appearing in the
//[[CL:Glossary:source code]]// being compiled are expanded, if at all, at compile time;
they will not be expanded at run time.



 \itemitem{\bull} All //[[CL:Glossary:macro]]//\idxterm{macro} and 
//[[CL:Glossary:symbol macro]]//\idxterm{symbol macro} calls
...
\itemitem{\bull} 
The first //[[CL:Glossary:argument]]// in a \specref{load-time-value}\idxref{load-time-value}
//[[CL:Glossary:form]]// 
in //[[CL:Glossary:source code]]// processed by **[[CL:Functions:compile]]**\idxref{compile}
is //[[CL:Glossary:evaluated]]// at //[[CL:Glossary:compile time]]//;
in //[[CL:Glossary:source code]]// processed by **[[CL:Functions:compile-file]]**\idxref{compile-file}, 
...
\specref{load-time-value} //[[CL:Glossary:form]]// at //[[CL:Glossary:execution time]]//.
...
\macref{defstruct} in the //[[CL:Glossary:compilation environment]]// must
...
\specref{eval-when}, denoted by the symbols **'':compile-toplevel''**,
**'':load-toplevel''**, and **'':execute''**.  For top level 
\specref{eval-when} forms, **'':compile-toplevel''** specifies that the
...
The behavior of this //[[CL:Glossary:form]]// can be more precisely understood in
...
\beginlist
\issue{DEFINE-COMPILER-MACRO:X3J13-NOV89}
 \itemitem{1.} If the //[[CL:Glossary:form]]// is a //[[CL:Glossary:compiler macro form]]//
...
A dash (---) indicates the compiler remains in its current mode.
 ...
 \itemitem{6.} Otherwise, the form is a //[[CL:Glossary:top level form]]// that
...
including the //[[CL:Glossary:forms]]// in the body of the \specref{eval-when} //[[CL:Glossary:form]]//;
...
Defining //[[CL:Glossary:macros]]// (such as \macref{defmacro} or \macref{defvar})
...
more \specref{eval-when} //[[CL:Glossary:forms]]//, and that the calls which cause the compile-time
...
definition inside the \specref{eval-when} //[[CL:Glossary:form]]//, as in:
...
//[[CL:Glossary:Compiler macro]]// expansions must also have the same
...
The fact that the //[[CL:Glossary:file compiler]]// represents //[[CL:Glossary:literal]]// //[[CL:Glossary:objects]]// 
...
//[[CL:Glossary:Implementations]]// providing additional, //[[CL:Glossary:implementation-defined]]// 
...
on neither the //[[CL:Glossary:current readtable]]// nor how \thefunction{read} would
...
as a //[[CL:Glossary:copy]]//\meaning{5} of $C$
when given as the //random-state// //[[CL:Glossary:argument]]// to \thefunction{random}, 
...
Two //[[CL:Glossary:conses]]//, $S$ and $C$, are //[[CL:Glossary:similar]]// if
    the //[[CL:Glossary:car]]//\meaning{2} of $S$ is //[[CL:Glossary:similar]]// to the //[[CL:Glossary:car]]//\meaning{2} of $C$,
and the //[[CL:Glossary:cdr]]//\meaning{2} of $S$ is //[[CL:Glossary:similar]]// to the //[[CL:Glossary:cdr]]//\meaning{2} of $C$.
...
a //[[CL:Glossary:subclass]]// of either \typeref{structure-object} or \typeref{standard-object}.
...
Some //[[CL:Glossary:objects]]//, such as //[[CL:Glossary:streams]]//, \typeref{readtables}, and \typeref{methods}
...
//[[CL:Glossary:package]]// of that name exists at load time.
 ...
 \item{}\b{random-state:} A constant //[[CL:Glossary:random state]]//
object cannot be used as the state argument 
to \thefunction{random} because **[[CL:Functions:random]]** modifies this data structure.
 
\item{}\b{structure, standard-object:}
//[[CL:Glossary:Objects]]// of //[[CL:Glossary:type]]// \typeref{structure-object} and \typeref{standard-object}
...
//[[CL:Glossary:generalized instance]]// of \typeref{standard-object},
...
\beginlist
\itemitem{1.} The //[[CL:Glossary:current package]]// when a //[[CL:Glossary:top level form]]// in the //[[CL:Glossary:file]]//
...
\itemitem{a.} Any //[[CL:Glossary:top level form]]// in a //[[CL:Glossary:file]]// that alters
...
\itemitem{b.} If the first //[[CL:Glossary:non-atomic]]// //[[CL:Glossary:top level form]]// in the //[[CL:Glossary:file]]//
	  is not an \macref{in-package} //[[CL:Glossary:form]]//, then the //[[CL:Glossary:current package]]//
...
//[[CL:Glossary:Conditions]]// \oftype{error} might be signaled by the compiler
...
//[[CL:Glossary:conditions]]// \oftype{warning} must or might be signaled,
...
for //[[CL:Glossary:conditions]]// \oftype{error}.  For example, they
...
Both **[[CL:Functions:compile]]** and **[[CL:Functions:compile-file]]** return three
