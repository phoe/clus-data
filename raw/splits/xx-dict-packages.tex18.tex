...
It is permissible for a //[[CL:Glossary:package]]// ''P\sub 1'' to //[[CL:Glossary:use]]// a //[[CL:Glossary:package]]// ''P\sub 2'' even if ''P\sub 2'' already uses ''P\sub 1''. The using of //[[CL:Glossary:packages]]// is not transitive, so no problem results from the apparent circularity.
