...
\itemitem{\bull} The functions **[[CL:Functions:open-stream-p]]** tests whether the //[[CL:Glossary:broadcast stream]]// is //[[CL:Glossary:open]]//, not whether its component streams are //[[CL:Glossary:open]]//.
