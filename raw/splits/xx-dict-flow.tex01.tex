...
\DefunWithValues apply {function ''&rest'' args''+''} {\starparam{result}}
...
When the //function// receives its arguments via \keyref{rest}, it is permissible (but not required) for the //[[CL:Glossary:implementation]]// to //[[CL:Glossary:bind]]// the //[[CL:Glossary:rest parameter]]// to an //[[CL:Glossary:object]]// that shares structure with the last argument to **[[CL:Functions:apply]]**. Because a //[[CL:Glossary:function]]// can neither detect whether it was called via **[[CL:Functions:apply]]** nor whether (if so) the last argument to **[[CL:Functions:apply]]** was a //[[CL:Glossary:constant]]//, //[[CL:Glossary:conforming programs]]// must neither rely on the //[[CL:Glossary:list]]// structure of a //[[CL:Glossary:rest list]]// to be freshly consed, nor modify that //[[CL:Glossary:list]]// structure.
