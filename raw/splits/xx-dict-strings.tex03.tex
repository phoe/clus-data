...
A //[[CL:Glossary:simple string]]// is a specialized one-dimensional //[[CL:Glossary:simple array]]// whose //[[CL:Glossary:element|elements]]// are \oftypes{character}. When used as a //[[CL:Glossary:type specifier]]// for object creation, **[[CL:Types:simple-string]]** means ''(simple-array character (''size''))''.
