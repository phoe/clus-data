...
Creates and returns a copy of the specified //table//, or of \thevalueof{*print-pprint-dispatch*} if no //table// is specified, or of the initial //[[CL:Glossary:value]]// of **[[CL:Variables:*print-pprint-dispatch*]]** if **[[CL:Constant Variables:nil]]** is specified.
