...
If //stream// is a //[[CL:Glossary:pretty printing stream]]// and \thevalueof{*print-pretty*} is //[[CL:Glossary:true]]//, a line break is inserted in the output when the appropriate condition below is satisfied; otherwise, **[[CL:Functions:pprint-newline]]** has no effect.
