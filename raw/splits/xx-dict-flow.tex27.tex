...
The //statements// in a \specref{tagbody} are //[[CL:Glossary:evaluated]]// in order from left to right, and their //[[CL:Glossary:values]]// are discarded. If at any time there are no remaining //statements//, \specref{tagbody} returns **[[CL:Constant Variables:nil]]**.
