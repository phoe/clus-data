...
\Thevalueof{*load-pathname*} must always be a //[[CL:Glossary:pathname]]// or **[[CL:Constant Variables:nil]]**. \Thevalueof{*load-truename*} must always be a //[[CL:Glossary:physical pathname]]// or **[[CL:Constant Variables:nil]]**.
