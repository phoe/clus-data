...
A //[[CL:Glossary:namestring]]// can be //[[CL:Glossary:coerced]]// to a //[[CL:Glossary:pathname]]// by \thefunctions{pathname}
...
\newtermidx{Pathnames}{pathname} are structured //[[CL:Glossary:objects]]// that can represent,
...
this operation is //[[CL:Glossary:implementation-dependent]]//,
