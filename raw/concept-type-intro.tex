...
New //[[CL:Glossary:types]]// can be defined using \macref{deftype}, \macref{defstruct}, 
...
(For example, every //[[CL:Glossary:object]]// is \oftype{t}, 
...
//[[CL:Glossary:Declarations]]// can be made about //[[CL:Glossary:types]]// using \misc{declare}, 
**[[CL:Functions:proclaim]]**, \macref{declaim}, or \specref{the}.
...
It is possible to write //[[CL:Glossary:functions]]// that have behavior //[[CL:Glossary:specialized]]//
